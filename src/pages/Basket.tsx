                    ...
                    <div className="mt-4">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg">
                          <button
                            type="button"
                            className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-50 rounded-l-md"
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          <button
                            type="button"
                            className="w-8 h-8 flex items-center justify-center text-gray-600 hover:bg-gray-50 rounded-r-md"
                            onClick={(e) => {
                              e.stopPropagation();
                              handleQuantityChange(item.product.id, item.quantity + 1);
                            }}
                      ...
                      <button
                        type="button"
                        className="text-[10px] text-gray-500 hover:text-red-500 hover:underline"
                        onClick={(e) => {
                          e.stopPropagation();
                          removeItem(item.product.id);
                        }}
                      >
                        <TrashIcon className="h-[0.7rem] w-[0.7rem] inline mr-[1px]" />
                        Remove
                      </button>
                    </div>
                  </div>
