...
const PillarsCarousel = () => {
    ...
    return (_jsxs("div", { className: 'pillars-carousel', onMouseEnter: () => setIsPaused(true), onMouseLeave: () => setIsPaused(false), children: [_jsx("button", { className: 'carousel-button prev', onClick: prevSlide, "aria-label": 'Previous slide', children: "<" }), _jsx("div", { className: 'carousel-track', ref: carouselTrackRef, children: pillars.map((pillar, index) => (_jsx("div", { className: 'carousel-slide', ref: (el) => (slideRefs.current[index] = el), onClick: () => handlePillarClick(pillar.fields.path), tabIndex: 0, children: _jsxs("div", { className: 'pillar-content', children: [_jsx("h3", { children: pillar.fields.title }), _jsx("p", { children: pillar.fields.description }), _jsxs("button", { className: 'explore-button', children: ["Explore ", pillar.fields.title] })] }) }, pillar.fields.title))) }), _jsx("button", { className: 'carousel-button next', onClick: nextSlide, "aria-label": 'Next slide', children: ">" }), _jsx("div", { className: 'carousel-dots', children: pillars.map((_, index) => (_jsx("button", { className: `dot ${index === currentIndex ? "active" : ""}`, onClick: () => scrollToSlide(index), "aria-label": `Go to slide ${index + 1}` }, index))) })] }));
};
